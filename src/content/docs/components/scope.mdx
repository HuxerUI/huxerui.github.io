...
Most application code should use `[[huxerui::composable]]`, which generates this boundary automatically while preserving natural function syntax.
...
- Preferred declaration syntax: `[[huxerui::composable]] View Component(...)`.
